...
const WriteLog = () => {
  ...
  return (
    <>
      ...
      <ImgUrl>
        <input type="text" placeholder="이미지 URL을 추가해주세요." className="imgurl"></input>
        <input type="text" placeholder="제목을 입력하세요." className="imgurl"></input>
        <input type="text" placeholder="날짜 입력하세요." className="imgurl"></input>
      </ImgUrl>
      <Dropdown>
